...
* [besu-eth/besu](https://github.com/besu-eth/besu) - An enterprise-grade Java-based, Apache 2.0 licensed Ethereum client https://wiki.hyperledger.org/display/besu
...
* [the3deer/android-3D-model-viewer](https://github.com/the3deer/android-3D-model-viewer) - Android OpenGL 2.0 application to view 3D models. Published on Play Store
